...
#'
#' This flexible prior structure on the number of neighbours is a beta-binomial distribution
#' with  two prior hyperparameters \code{a} and \code{b}. The resulting prior can be written as:
#'
#'  \deqn{
#'  p(\omega_{ij})\propto \Gamma\left(a+\sum\boldsymbol{\omega}_i\right)\Gamma\left(b+(N-1)-\sum\boldsymbol{\omega}_i\right),
#'  }
#'
...
#'  the prior can be anchored around the expected number of neigbors \eqn{m} through
...
#' @export bbinompdf
#'
#' @return Density of the beta binomial distribution evaluated at \code{x}.
#'
#' @references
