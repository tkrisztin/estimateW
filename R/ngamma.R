...
#' A Markov Chain Monte Carlo (MCMC) sampler for a linear model with independent Normal-Gamma priors
#'
...
#' classes.
#'
#' @param Y numeric \eqn{N \times 1} matrix containing the dependent variables.
...
#' A Markov Chain Monte Carlo (MCMC) sampler for the Spatial Durbin Model with exogeneous spatial weight matrix.
#'
