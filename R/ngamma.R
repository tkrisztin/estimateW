...
#' @param X numeric \eqn{tt * n} by \eqn{k_1} design matrix of independent variables. These will be
#' spatially lagged by \eqn{W}. The default value is a matrix with \eqn{tt * n} rows and zero columns.
#' @param Z numeric \eqn{tt * n} by \eqn{k_3} design matrix of independent variables. The default value
#' is a \eqn{tt * n} by \eqn{1} vector of ones (an intercept for the model).
