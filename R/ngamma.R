...
#' additionally spatially lagged by \eqn{W}. The default value is a matrix with \eqn{tt * n}
#' rows and zero columns.
#' @param Z numeric \eqn{tt * n} by \eqn{k_3} design matrix of independent variables (which are not
#' spatially lagged by \eqn{W}). The default value
